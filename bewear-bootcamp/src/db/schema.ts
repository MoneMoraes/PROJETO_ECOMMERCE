...
export const orderTable = pgTable("order", {
  ...
  email: text().notNull(),
  cpfOrCnpj: text().notNull(),
  totalPricesInCents: integer("total_price_in_cents").notNull(),
...
// tenis preto top das galáxias
// slug: tenis-preto-top-das-galaxias
// detalhes que melhoram o SEO da aplicação
// detalhes que melhoram a experiência do usuário
